...
public class Rental {
    ...
    private void setIssuedDate(LocalDateTime issuedDate) {
        this.issuedDate = issuedDate;
    }

    private void setExpectedReturnDate(LocalDateTime expectedReturnDate) {
        this.expectedReturnDate = expectedReturnDate;
    }

    private void setReturnedDate(LocalDateTime returnedDate) {
        this.returnedDate = returnedDate;
    }

    private void setStatus(RentalStatus status) {
        this.status = status;
    }
    ...
    public static class Builder {
        ...
        public Builder setIssuer(UUID issuer) {
            this.issuer = issuer;
            return this;
        }
