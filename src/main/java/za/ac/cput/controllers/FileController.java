 ...
 * It acts as a secure proxy, fetching files from the active storage backend (local or MinIO)
 * and streaming them to the client. This prevents direct exposure of the storage system.
 *
