 ...
 *
 * @RestController
 * @RequestMapping("/damageReport") public class DamageReportController {
 * @Autowired private DamageReportServiceImpl damageReportService;
 * @PostMapping("createReport") public ResponseEntity<DamageReport> create(@RequestBody DamageReport damageReport){
 * <p>
 ...
 * }
 * @GetMapping("readReport/{id}") public ResponseEntity<DamageReport> read(@PathVariable("id") int id){
 ...
 * }
 * @PutMapping("updateReport") public ResponseEntity<DamageReport> update(@RequestBody DamageReport damageReport){
 * DamageReport updateReport = damageReportService.update(damageReport);
 * return new ResponseEntity<>(updateReport,HttpStatus.OK);
 * }
 * @DeleteMapping("deleteReport/{id}") public ResponseEntity<?> delete(@PathVariable("id") int id){
 * this.damageReportService.deleteById(id);
 * return new ResponseEntity<>(HttpStatus.OK);
 * }
 * @GetMapping("getAllReports") public ResponseEntity<List<DamageReport>> getAll(){
