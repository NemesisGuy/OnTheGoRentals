...
import za.ac.cput.domain.entity.Driver; // For service layer interaction
...
public class DriverController {
    ...
    public ResponseEntity<DriverResponseDTO> updateDriver(
        ...
        existingDriver = DriverMapper.applyUpdateDtoToEntity(driverUpdateDTO, existingDriver); // Apply DTO changes to the entity
